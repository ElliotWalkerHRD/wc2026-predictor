...
const TEAMS = {
  // Group A
  'USA':        { name: 'United States',  flag: '🇺🇸', group: 'A', code: 'USA' },
  'MEX':        { name: 'Mexico',         flag: '🇲🇽', group: 'A', code: 'MEX' },
  'CAN':        { name: 'Canada',         flag: '🇨🇦', group: 'A', code: 'CAN' },
  'URU':        { name: 'Uruguay',        flag: '🇺🇾', group: 'A', code: 'URU' },
  // Group B
  'ARG':        { name: 'Argentina',      flag: '🇦🇷', group: 'B', code: 'ARG' },
  'CHI':        { name: 'Chile',          flag: '🇨🇱', group: 'B', code: 'CHI' },
  'PER':        { name: 'Peru',           flag: '🇵🇪', group: 'B', code: 'PER' },
  'AUS':        { name: 'Australia',      flag: '🇦🇺', group: 'B', code: 'AUS' },
  // Group C
  'BRA':        { name: 'Brazil',         flag: '🇧🇷', group: 'C', code: 'BRA' },
  'COL':        { name: 'Colombia',       flag: '🇨🇴', group: 'C', code: 'COL' },
  'PAR':        { name: 'Paraguay',       flag: '🇵🇾', group: 'C', code: 'PAR' },
  'JPN':        { name: 'Japan',          flag: '🇯🇵', group: 'C', code: 'JPN' },
  // Group D
  'ENG':        { name: 'England',        flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', group: 'D', code: 'ENG' },
  'SEN':        { name: 'Senegal',        flag: '🇸🇳', group: 'D', code: 'SEN' },
  'SRB':        { name: 'Serbia',         flag: '🇷🇸', group: 'D', code: 'SRB' },
  'NZL':        { name: 'New Zealand',    flag: '🇳🇿', group: 'D', code: 'NZL' },
  // Group E
  'FRA':        { name: 'France',         flag: '🇫🇷', group: 'E', code: 'FRA' },
  'DEN':        { name: 'Denmark',        flag: '🇩🇰', group: 'E', code: 'DEN' },
  'TUN':        { name: 'Tunisia',        flag: '🇹🇳', group: 'E', code: 'TUN' },
  'SAU':        { name: 'Saudi Arabia',   flag: '🇸🇦', group: 'E', code: 'SAU' },
  // Group F
  'ESP':        { name: 'Spain',          flag: '🇪🇸', group: 'F', code: 'ESP' },
  'CRO':        { name: 'Croatia',        flag: '🇭🇷', group: 'F', code: 'CRO' },
  'MAR':        { name: 'Morocco',        flag: '🇲🇦', group: 'F', code: 'MAR' },
  'BEL':        { name: 'Belgium',        flag: '🇧🇪', group: 'F', code: 'BEL' },
  // Group G
  'POR':        { name: 'Portugal',       flag: '🇵🇹', group: 'G', code: 'POR' },
  'POL':        { name: 'Poland',         flag: '🇵🇱', group: 'G', code: 'POL' },
  'IRN':        { name: 'Iran',           flag: '🇮🇷', group: 'G', code: 'IRN' },
  'CMR':        { name: 'Cameroon',       flag: '🇨🇲', group: 'G', code: 'CMR' },
  // Group H
  'GER':        { name: 'Germany',        flag: '🇩🇪', group: 'H', code: 'GER' },
  'NED':        { name: 'Netherlands',    flag: '🇳🇱', group: 'H', code: 'NED' },
  'ALG':        { name: 'Algeria',        flag: '🇩🇿', group: 'H', code: 'ALG' },
  'KOR':        { name: 'South Korea',    flag: '🇰🇷', group: 'H', code: 'KOR' },
  // Group I
  'ITA':        { name: 'Italy',          flag: '🇮🇹', group: 'I', code: 'ITA' },
  'ECU':        { name: 'Ecuador',        flag: '🇪🇨', group: 'I', code: 'ECU' },
  'UKR':        { name: 'Ukraine',        flag: '🇺🇦', group: 'I', code: 'UKR' },
  'NGA':        { name: 'Nigeria',        flag: '🇳🇬', group: 'I', code: 'NGA' },
  // Group J
  'ARG2':       { name: 'Venezuela',      flag: '🇻🇪', group: 'J', code: 'VEN' },
  'SUI':        { name: 'Switzerland',    flag: '🇨🇭', group: 'J', code: 'SUI' },
  'CIV':        { name: "Côte d'Ivoire",  flag: '🇨🇮', group: 'J', code: 'CIV' },
  'THA':        { name: 'Thailand',       flag: '🇹🇭', group: 'J', code: 'THA' },
  // Group K
  'NOR':        { name: 'Norway',         flag: '🇳🇴', group: 'K', code: 'NOR' },
  'AUT':        { name: 'Austria',        flag: '🇦🇹', group: 'K', code: 'AUT' },
  'EGY':        { name: 'Egypt',          flag: '🇪🇬', group: 'K', code: 'EGY' },
  'MEX2':       { name: 'Qatar',          flag: '🇶🇦', group: 'K', code: 'QAT' },
  // Group L
  'TUR':        { name: 'Turkey',         flag: '🇹🇷', group: 'L', code: 'TUR' },
  'HUN':        { name: 'Hungary',        flag: '🇭🇺', group: 'L', code: 'HUN' },
  'RSA':        { name: 'South Africa',   flag: '🇿🇦', group: 'L', code: 'RSA' },
  'COD':        { name: 'DR Congo',       flag: '🇨🇩', group: 'L', code: 'COD' },
};
...
function getTeam(code) {
  return TEAMS_LIST.find(t => t.code === code) || { code, name: code, flag: '🏳️' };
}
